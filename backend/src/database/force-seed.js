...
async function forceSeed() {
  ...
  try {
    ...
    const tables = [
      'users', 'user_roles', 'stores', 'products', 'wallets', 
      'wallet_transactions', 'delivery_addresses', 'carts', 'cart_items', 
      'vouchers', 'promos', 'orders', 'order_items', 'order_status_history', 
      'delivery_jobs', 'app_reviews', 'system_settings'
    ];
